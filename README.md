...
Expenses like travel, meals, and lodging are displayed in a separate section since they can be non-billable and shouldn't distort the estimate-to-actual comparison.
